...
4. Use the generated ratchet helper (`.m-spec/templates/autoresearch.ratchet.sh`) to codify keep/discard decisions.
5. Record each run in `autoresearch.jsonl` and summarize wins, losses, and dead ends in `autoresearch.md`.
6. Do not relax correctness checks to chase the metric.
